...
<input type="hidden" name="Subscriber[author_id]" value="<?=$author->id?>">
<div class="form-group mb-4 row form-row align-items-baseline">
    ...
    <div class="col-sm-10">
        <input type="text" name="Subscriber[phone]" id="subscribe-phone" class="form-control" placeholder="<?=Yii::t('backend','Phone')?>">
    </div>
</div>
<div class="form-group mb-4 row form-row align-items-baseline">
    <label class="control-label col-sm-2" for="subscribe-name"><?=Yii::t('backend','Name')?></label>
    <div class="col-sm-10">
        <input type="text" name="Subscriber[name]" id="subscribe-name" class="form-control" placeholder="<?=Yii::t('backend','Name')?>">
    </div>
</div>
<div class="form-group">
    <?= Html::submitButton(Yii::t('backend', 'Subscribe'), ['class' => 'btn btn-primary']) ?>
